    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Form Wisata</h3>
                        <ul class="breadcrumb">
                                ...
                                <div ng-controller="studentCtrl">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input wire:model='lat' id="Latitude" type="text"
                                            ...
                                            <td>
                                                <input wire:model='lng' id="Longitude" type="text"
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            <tr>
                                <td></td>
                                <td colspan="3">
                                    <a href="{{ route('wisata') }}" class="btn btn-danger"><i
