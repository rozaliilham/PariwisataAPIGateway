                ...
                <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
                    <div class="blog grid-blog flex-fill">
                        <div class="blog-image">
                            <a href="{{ route('news') }}"><img class="img-fluid" src="{{ asset('storage/'.$row->image) }}"
                                    alt="Post Image"></a>
                        ...
                        <div class="blog-content">
                            ...
                            <h3 class="blog-title"><a href="/gallery">{{$row->title}} </a></h3>
                            <p>
                                {{ Str::substr($row->body, 0, 110) }}
                            </p>
                        </div>
                        <br>
                        <center>
                            <div class="row ">
                                <div class="edit-options justify-content-center">
                                    <div class="edit-delete-btn">
                                        <a href="{{ route('edit-news',$row->id) }}"
                                            class="btn btn-warning border-0"><i class="feather-edit-3 me-1"></i>
                                            Edit</a>
                                        <a wire:click="$emit('triggerDelete',{{ $row->id }})" class="btn btn-warning border-0"><i
                                                class="feather-trash-2 me-1"></i>
                                            Delete</a>
                                        <a href="{{ route('detail-news',$row->id) }}"
