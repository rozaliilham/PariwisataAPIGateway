                            ...
                            <div class="entry-meta">
                                <ul>
                                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a
                                            href="{{ route('detail-wisatafront',Crypt::encrypt($row->id)) }}">{{ $row->user->name
                                            }}</a></li>
                                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                            href="{{ route('detail-wisatafront',Crypt::encrypt($row->id)) }}"><time
                                                datetime="2020-01-01">{{
                                                Carbon\Carbon::parse($row->created_at)->format("d F, Y") }}</time></a>
                                    </li>
                                    <li class="d-flex align-items-center"><i class="bi bi-eye"></i> <a
                                            href="{{ route('detail-wisatafront',Crypt::encrypt($row->id)) }}">{{ $row->views }}
                                            Views</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar-item search-form">
                                <input type="text" placeholder="Cari berdasarkan nama wisata..." wire:model="search"
                                    class="form-control">
                            ...
                            <div class="sidebar-item categories">
                                <ul>
                                    ...
                                    <li><a
                                            href="{{ route('bycategorywisata',['category_id' => Crypt::encrypt($cat->id)] ) }}">{{
                                            $cat->title }} </a></li>
                                    @endforeach
