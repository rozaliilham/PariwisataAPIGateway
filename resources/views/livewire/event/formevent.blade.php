    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Form Agenda</h3>
                        <ul class="breadcrumb">
                            ...
                            <form wire:submit.prevent="uploadImage">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input wire:model.lazy='lat' id="Latitude" type="text"
                                        ...
                                        <td>
                                            <input wire:model.lazy='lng' id="Longitude" type="text"
                                    ...
                                    <tr>
                                        <td>Lokasi Agenda</td>
                                        <td colspan="3">
                                            <textarea class="form-control" placeholder="Lokasi agenda" wire:model='lokasi'></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Keterangan / Deskripsi</td>
                                        <td colspan="3">
                                            <textarea class="form-control" placeholder="Keterangan / Deskripsi" wire:model='ket'></textarea>
                                        </td>
                                    </tr>
                                    <tr>
